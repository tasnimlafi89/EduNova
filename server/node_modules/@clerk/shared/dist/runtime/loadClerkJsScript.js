...
const require_versionSelector = require('./versionSelector-DzvYsGER.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.6.2")}/dist/ui.browser.js`;
};
